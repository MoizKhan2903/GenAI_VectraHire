...
//  * @description clear token from user and cookie and add token to blacklist
//  * @access public
//  */
...
async function registerUserController(req, res) {
    try {
        ...
        // Sign with _id to match middleware decoded._id
...
async function getMeController(req, res) {
    try {
        await connectToDB();
        // UPDATED: Now looks for req.user._id to match your new middleware
